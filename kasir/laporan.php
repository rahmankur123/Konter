...
// Tentukan Cabang: Kasir dikunci, Pemilik fleksibel via filter
if (!$isOwner) {
...
// ============================================================
// MASTER LIST UNTUK FILTER (CABANG & KASIR)
// ============================================================
$cabang_list = [];
if ($isOwner) {
    $cabang_list = $conn->query("SELECT id, Nama_cabang FROM Cabang ORDER BY Nama_cabang ASC")->fetch_all(MYSQLI_ASSOC);
    $kasir_query = "SELECT id, nama_lengkap, id_cabang FROM users WHERE role = 'kasir' ORDER BY nama_lengkap ASC";
} else {
    $kasir_query = "SELECT id, nama_lengkap, id_cabang FROM users WHERE role = 'kasir' AND id_cabang = '{$_SESSION['id_cabang']}' ORDER BY nama_lengkap ASC";
}
...
<head>
    ...
    <style>
        @media print {
            ...
            .kasir-modern { background: white !important; color: #000 !important; }
            .kasir-modern * { color: #000 !important; -webkit-text-fill-color: #000 !important; }
        }
    </style>
</head>
...
<body class="kasir-modern mobile-card-tables">
    ...
    <main class="main-content">
        <div class="mb-4">
            ...
            <p class="text-muted">
                <?= $isOwner ? 'Monitoring penjualan seluruh cabang Fedly Cell' : 'Laporan transaksi cabang <strong>' . htmlspecialchars($_SESSION['nama_cabang'] ?? '') . '</strong>' ?>
            </p>
        </div>
        ...
        <div class="row g-4 mb-4 report-summary">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="stats-card green">
                    ...
                    <h3 style="font-size:1.2rem;"><?= formatRupiah($statistik['total_pendapatan']) ?></h3>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="stats-card orange">
                    ...
                    <h3 style="font-size:1.2rem;"><?= formatRupiah($statistik['tunai']) ?></h3>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="stats-card red">
                    ...
                    <h3 style="font-size:1.2rem;"><?= formatRupiah($statistik['transfer'] + $statistik['qris']) ?></h3>
                    <p>Non-Tunai</p>
                    <span class="badge bg-danger">Transfer & QRIS</span>
                </div>
            </div>
        </div>
                                ...
                                <?php else: ?>
                                    <?php foreach ($transaksi as $t): ?>
                                        <tr>
                                            ...
                                            <td class="no-print">
                                                <a href="transaksi.php?struk=<?= $t['id'] ?>" class="btn btn-info btn-sm text-white" title="Lihat Struk" target="_blank">
